    ...
    function report(node) {
      context.report({
        ...
        fix: function(fixer) {
          ...
          if (!defaultExport) {
            console.warn('Could not find the default export');
            return;
          }
          ...
          if (!body) {
            console.warn('Could not find the React component body');
            return;
          }
          if (body.length !== 1) {
            console.warn('More than one React component body candidate found');
            return;
          }
